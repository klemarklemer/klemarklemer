...
import (
	"monorepo/services/core/internal/modules/claim"
	"monorepo/services/core/internal/modules/officer"
	"monorepo/services/core/internal/modules/policy"

	"monorepo/services/core/configs"
...
func NewService(cfg *config.Config) factory.ServiceFactory {
	...
	modules := []factory.ModuleFactory{
		claim.NewModule(deps),
		officer.NewModule(deps),
		policy.NewModule(deps),
	}
