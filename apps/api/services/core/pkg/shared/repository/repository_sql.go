...
import (
	...
	policyrepo "monorepo/services/core/internal/modules/policy/repository"
	officerrepo "monorepo/services/core/internal/modules/officer/repository"
	claimrepo "monorepo/services/core/internal/modules/claim/repository"
...
type (
	...
	RepoSQL interface {
		...
		OfficerRepo() officerrepo.OfficerRepository
...
func NewRepositorySQL(readDB, writeDB *gorm.DB) RepoSQL {
	...
	return &repoSQLImpl{
		...
		policyRepo: policyrepo.NewPolicyRepoSQL(readDB, writeDB),
		officerRepo: officerrepo.NewOfficerRepoSQL(readDB, writeDB),
		claimRepo: claimrepo.NewClaimRepoSQL(readDB, writeDB),
	}
}
...
func (r *repoSQLImpl) PolicyRepo() policyrepo.PolicyRepository {
	return r.policyRepo
}

func (r *repoSQLImpl) OfficerRepo() officerrepo.OfficerRepository {
	return r.officerRepo
}

func (r *repoSQLImpl) ClaimRepo() claimrepo.ClaimRepository {
	return r.claimRepo
}
