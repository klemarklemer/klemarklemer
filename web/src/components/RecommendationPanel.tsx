        ...
        <div className="space-y-4">
          ...
          {claim.closed ? (
            <div className="p-4 bg-zinc-900 text-white rounded-md flex items-center justify-between">
              ...
              <span className="text-xs bg-teal-800 text-teal-100 px-2.5 py-1 rounded">Assessment PDF Stored</span>
            </div>
          ) : (
            <>
              {claim.decision && (
              ...
              <div className="space-y-3 pt-2 border-t border-zinc-100">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <button
                    onClick={onReject}
                    className="flex-1 border border-red-300 text-red-700 hover:bg-red-50 focus-visible:ring-2 focus-visible:ring-teal-700 focus-visible:ring-offset-2 py-2.5 px-4 rounded-md text-sm font-medium transition cursor-pointer"
                  >
                    Reject
                  </button>
                </div>
